...
class FactsControllerTest < ActionController::TestCase
  ...
  test "should create fact" do
    assert_difference('Fact.count') do
      post :create, fact: { fact_text: @fact.fact_text, project_name: @fact.project_name, user_id: @fact.user_id }
    end
  ...
  test "should update fact" do
    patch :update, id: @fact, fact: { fact_text: @fact.fact_text, project_name: @fact.project_name, user_id: @fact.user_id }
    assert_redirected_to fact_path(assigns(:fact))
  end
